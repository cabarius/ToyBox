...
namespace ToyBox {
    ...
    static class UnitEntityDataUtils {
        public static float GetMaxSpeed(IEnumerable<UnitEntityData> data) {
        ...
        public static bool CheckUnitEntityData(UnitEntityData unitEntityData, UnitSelectType selectType) {
            ...
            switch (selectType) {
                ...
                case UnitSelectType.Party:
                    return unitEntityData.IsPlayerFaction;

                case UnitSelectType.You:
                    return unitEntityData.IsMainCharacter;
                ...
                case UnitSelectType.Enemies:
                    ...
                    return !unitEntityData.IsPlayerFaction && unitEntityData.Descriptor.AttackFactions.Contains(Game.Instance.BlueprintRoot.PlayerFaction);
        ...
        public static void AddCompanion(UnitEntityData unit) {
            ...
            if (currentMode == GameModeType.Default || currentMode == GameModeType.Pause) {
                ...
                foreach ((UnitEntityData entity, var _) in pets) {
                    entity.Position = unit.Position;
                }
            }
        }
