...
namespace ToyBox
{
    abstract public class BlueprintAction
    {
        ...
        public static void Register<BPType>(string name,
                                            BlueprintAction<BPType>.Perform action,
                                            BlueprintAction<BPType>.CanPerform canPerform = null,
                                            bool isRepeatable = false) where BPType : SimpleBlueprint
        {
            var bpAction = new BlueprintAction<BPType>(name, action, canPerform, isRepeatable);

            var type = bpAction.BlueprintType;
    ...
    public static class BlueprintActions
    {
        ...
        public static void InitializeActions()
        {
            ...
            BlueprintAction.Register<BlueprintFeature>("<",
                                                       (bp, ch, n) => ch.Progression.Features.GetFact(bp)?.RemoveRank(), (bp, ch) =>
                                                       {
            ...
            BlueprintAction.Register<BlueprintFeature>(">",
                                                       (bp, ch, n) => ch.Progression.Features.GetFact(bp)?.AddRank(), (bp, ch) =>
                                                       {
                                                           var feature = ch.Progression.Features.GetFact(bp);
            ...
            BlueprintAction.Register<BlueprintSpellbook>(">",
                                                         ...
                                                         (bp, ch) => ch.Descriptor.Spellbooks.Any(
                                                             sb => sb.Blueprint == bp && sb.CasterLevel < bp.MaxSpellLevel));
            ...
            BlueprintAction.Register<Cutscene>("Play", (bp, ch, n) =>
                                                       {
                                                           ...
                                                           CutscenePlayerData cutscenePlayerData
                                                               = CutscenePlayerData.Queue.FirstOrDefault(c => c.PlayActionId == bp.name);
            ...
            BlueprintAction.Register<BlueprintArea>("Teleport", (area, ch, n) =>
                                                                {
                                                                    ...
                                                                    var blueprint = areaEnterPoints.FirstOrDefault(
                                                                        bp => bp is BlueprintAreaEnterPoint ep && ep.Area == area);
