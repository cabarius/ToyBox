                                                       ...
                                                       else if (questObjective.State == QuestObjectiveState.Started)
                                                       {
                                                           ...
                                                           if (questObjective.Blueprint.AutoFailDays > 0)
                                                           {
                                                               UI.ActionButton("Reset Time", () =>
                                                                                             {
                                                                                                 Traverse.Create(questObjective).Field("m_ObjectiveStartTime")
                                                                                                         .SetValue(Game.Instance.Player.GameTime);
                                                                                             }, UI.AutoWidth());
                                                           }
                                                       }
                                                       else if (questObjective.State == QuestObjectiveState.Failed &&
                                                                (questObjective.Blueprint.IsFinishParent || quest.State == QuestState.Started))
                                                       {
                                                           UI.ActionButton("Restart", () =>
                                                                                      {
                                                                                          ...
                                                                                          {
                                                                                              Traverse.Create(quest).Field("m_State")
                                                                                                      .SetValue(QuestState.Started);
                                                                                          }
                                            ...
                                            UI.HStack(null, 0, () =>
                                                               {
                                                                   ...
                                                                   {
                                                                       UI.ActionButton(
                                                                           childObjective.Blueprint.IsFinishParent ? "Complete (Final)" : "Complete", () =>
                                                                           {
