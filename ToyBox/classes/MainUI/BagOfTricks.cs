...
#if DEBUG
                () => Toggle("Allow " + "Same".color(RGBA.purple) + " " + "Sex for all " + "R".color(RGBA.red) + "o".orange() + "m".yellow() + "a".green() + "n".cyan() + "c".color(RGBA.rare) + "e".color(RGBA.purple), ref settings.toggleAllowAnyGenderRomance),
