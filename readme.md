...
_1. Find the highest release name near the top. It will look something like `Ver 1.3.7`. 
_1. Usually it is 1 higher than the current release, if not add a new line for the next release
_1. don't worry too much about getting this right as Narria Cabarius will clean this up on merge
_1. format your release note like like this:```
